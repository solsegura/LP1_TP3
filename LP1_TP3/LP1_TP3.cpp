...
cout<<"  _  _   /'/    )\,/,/(_   \ \                             "<<endl;
cout<<"   `//-.|  (  ,\\)\//\)\/_  ) |	                          "<<endl;
cout<<"   //___\   `\\\/\\/\/\\///'  /	     TE DEJAMOS ESTA VACA "<<endl;
cout<<",-'~`-._ - - '_   `'''`  _ \`''~ - ,       DE LA SUERTE    "<<endl;
cout<<"\       `-.  '_`.      .'_` \ ,-'~`     PARA QUE CORRIJAS  "<<endl;
cout<<" `.__.-'`/   (-\        /-) |-.__,'          CON MUCHO     "<<endl;
cout<<"   ||   |     \O)  /^\ (O/  |	              AMOR        "<<endl;
cout<<"   `\\  |         /   \    /	                              "<<endl;
cout<<"     \\  \       /      \ /		                          "<<endl;
cout<<"      `\\ `-.  /'.---.--.\		                          "<<endl;
...
cout<<"         				                                  "<<endl;
	...
	delete TodosLosDonantes;
	delete TodosLosReceptores;
